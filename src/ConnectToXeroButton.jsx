...
function ConnectToXeroButton() {
  const handleConnectToXero = () => {
    ...
    const redirectUri = encodeURIComponent('https://pilkadaris.com.au/');
    const scope = encodeURIComponent('openid profile email offline_access accounting.transactions accounting.contacts');
    const state = 'YOUR_STATE'; // Generate a unique state value for each authorization request
